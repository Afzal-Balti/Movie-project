    ...
    <div>
      <div className="w-full relative md:mt-20 mt-0 ">
        ...
        <div className="w-full md:justify-items-center justify-items-center  md:py-20 text-center  absolute inset-0 ">
          ...
          <div className="md:w-1/3  w-full md:h-80  md:mt-16  text-2xl ">
            <div className="w-full md:py-5 py-5 text-white flex md:flex-row flex-col text-center justify-between">
              <h2>Home</h2>
              <h2>Live</h2>
