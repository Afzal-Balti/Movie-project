...
const FiltersData: React.FC<Props> = ({ data }) => {
  ...
  return (
    <>
      <div
        data-aos="fade-down"
        className="w-full h-full flex flex-nowrap overflow-x-scroll no-scrollbar gap-14 md:px-10 px-2   "
      >
          ...
          <div className="flex shrink-0 " key={items.id}>
            <div className="w-full h-full">
              <img
                ...
                className="md:w-60 md:h-100 w-60 hover:bg-slate-400 h-100 rounded-xl object-cover cursor-pointer  "
